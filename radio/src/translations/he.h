...
#define TR_VMLTPX2                     "+=","*=",":="
#if defined(PCBHORUS)
  #define TR_VMIXTRIMS                 "OFF","ON","הגה כיוון","הגה גובה","מצערת","מאזנות","T5","T6"
#else
  #define TR_VMIXTRIMS                 "OFF","ON","הגה כיוון","הגה גובה","מצערת","מאזנות"
#endif
...
#define TR_STICKS_VSRCRAW              STR_CHAR_STICK "הגה כיוון", STR_CHAR_STICK "הגה גובה", STR_CHAR_STICK "מצערת", STR_CHAR_STICK "מאזנות"

#if defined(PCBHORUS)
  #define TR_TRIMS_VSRCRAW             STR_CHAR_TRIM "הגה כיוון", STR_CHAR_TRIM "הגה גובה", STR_CHAR_TRIM "מצערת", STR_CHAR_TRIM "מאזנות", STR_CHAR_TRIM "T5", STR_CHAR_TRIM "T6"
#else
  #define TR_TRIMS_VSRCRAW             STR_CHAR_TRIM "הגה כיוון", STR_CHAR_TRIM "הגה גובה", STR_CHAR_TRIM "מצערת", STR_CHAR_TRIM "מאזנות"
#endif
...
#define TR_VUSBJOYSTICK_CH_SIM         "מאזנות","הגה גובה","הגה כיוון","מנוע"
